...
class ctrlPID:
    def __init__(self):
        ...
        # Pi_pitch = -1.0   # try -1.0, -5.0, etc. and tune

        # self.kd_pitch = ((2 * zeta_pitch * wn_pitch - Pi_pitch) / b_theta)
        # self.kp_pitch = (wn_pitch**2 - 2 * zeta_pitch * wn_pitch * Pi_pitch) / b_theta
